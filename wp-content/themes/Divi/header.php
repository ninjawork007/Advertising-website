...
?>
				...
				<div id="et-top-navigation" data-height="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>" data-fixed-height="<?php echo esc_attr( et_get_option( 'minimized_menu_height', '40' ) ); ?>">
					<?php if ( ! $et_slide_header || is_customize_preview() ) : ?>
						...
						<?php
							...
							$secondaryNav = '<ul id="top-menu" class="nav">'.
							'<li id="menu-item-418" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-416 current_page_item menu-item-418"><a href="http://localhost:8080/wordpress/" aria-current="page">Home</a></li>'.
							'<li id="menu-item-18" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-18"><a href="http://localhost:8080/wordpress/login/">Login</a></li>'.
							'</ul>';
							if ( empty( $primaryNav ) ) :
						?>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			$('#menu-item-564 a').attr('href', '#');
		})
		
		$('#menu-item-564 a').click(function() {
			$.post('../wp-content/themes/Divi/database/user_sign_up.php',
				{
					func_check: 'logout'
				}, function(data) {
	...
	<script type="text/javascript">
		var site_url = '<?php echo site_url();?>';
		$('#et_search_icon').css("visibility", "hidden");
	</script>	
	<?php
		endif;
	?>